...
--
-- Host: 127.0.0.1
-- Tempo de geração: 10-Out-2024 às 22:45
...
INSERT INTO `usuarios` (`idUsuario`, `nomeUsuario`, `sobrenomeUsuario`, `generoUsuario`, `enderecoUsuario`, `cidadeUsuario`, `numeroEnderecoUsuario`, `cepUsuario`, `complementoUsuario`, `emailUsuario`, `senhaUsuario`) VALUES
(2, 'Ana Clara', 'Borges', 'feminino', 'Alphaville Graciosa', 'telemaco', '77', '846232-09', 'Condomínio', 'analaclara@gmail.com', '8049d510630025402e94d733085210d7');
